...
# Add the src folder to Python path to import ai.py
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'src'))
from adapters.ai import BedrockAI

# 30+ labeled test rows (including cryptic edges cases)
TEST_DATA = [
    # Clear cases
    ...
    ("VIETTEL POST", -25000, "Shopping"), # Or Transport, let's say Shopping for parcel
    ...
    # Ambiguous / Messy cases
    ("VINMART HCM 04", -120000, "Food"), # Could be Shopping, we expect AI to guess Food or Shopping
    ...
    # Cryptic / Failure cases (Expect: Other)
